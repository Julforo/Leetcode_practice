...
#define k2	3
#define k3	(10-k1-k2)
#define PMFS_DIR_AWD(filesize,filecount,freq)	(filesize*k1+filecount*k2+freq*k3)

/* PMFS awd flag */
#define PMFS_FILE_CREATE 0
#define PMFS_FILE_READ 1
#define PMFS_FILE_WRITE 2
#define PMFS_FILE_APPEND 3
#define PMFS_FILE_DELETE 4
#define PMFS_FILE_RENAME 5
...
struct pmfs_inode {
	...
	__le32  i_awd;				/* App-aware property(for dir)*/
	__le32	i_fcount;			/* file count of this dir */
	__le16	i_fsize;			/* total file's blocks count -> pmfs_origin have defined i_size*/
	__le32	i_acfreq;			/* access frequency for this dir/file currently view it as i_count in inode. */
